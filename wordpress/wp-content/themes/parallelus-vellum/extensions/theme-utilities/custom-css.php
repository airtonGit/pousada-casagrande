...
function theme_custom_styles() {
	...
	if (!empty($accent_1) && $accent_1 !== '#') {
		...
		$accentStyles  = '.accent-primary, article.format-quote a:hover .post-header, article.format-link a:hover .post-header, .overlay-slide-effect .inner-overlay i, .jp-play-bar, .jp-volume-bar-value, .impactBtn, .impactBtn:hover, .impactBtn:active, body a.impactBtn, body a.impactBtn:link, body a.impactBtn:visited, .wpb_call_to_action .wpb_button.wpb_accent-primary, .wpb_call_to_action .wpb_button.wpb_accent-primary:hover, .wpb_call_to_action .wpb_button.wpb_accent-primary:active, .vc_progress_bar .vc_single_bar.accent-primary .vc_bar { background-color: '. $accent_1 .'; }';
		$accentStyles .= '.accent-primary-border, .inner-overlay i.fa, [class*="image-border-"] img, .wpb_button.wpb_accent-primary, .wpb_button.wpb_accent-primary:active { border-color: '. $accent_1 .'; }';
		$accentStyles .= 'div.wpb_tour .ui-tabs .ui-tabs-nav li.ui-tabs-active a, div.wpb_tour .ui-tabs .ui-tabs-nav li.ui-tabs-active a:hover, body #megaMenu ul.megaMenu > li.menu-item.current-menu-item > a  { border-bottom-color: '. $accent_1 .'; }';
	...
	$linkColor = (isset($layout_options['link-color']) && !empty($layout_options['link-color'])) ? $layout_options['link-color'] : get_options_data('options-page', 'link-color'); 
	...
	// Hover (links)
	$hoverColor = (isset($layout_options['link-hover-color']) && !empty($layout_options['link-hover-color'])) ? $layout_options['link-hover-color'] : get_options_data('options-page', 'link-hover-color'); 
	...
	if( !empty( $active_color ) && $active_color != '#' ) {
		$CustomStyles .= '#MainNav #megaMenu ul.megaMenu li.current-menu-item.ss-nav-menu-item-depth-0 > a span { color:'.$active_color.' }';
	} 
	...
	if ($mastheadBg) {
		// Get the styles
		$mastheadStyles = '.boxed #masthead, .full-width #masthead, .boxed-left #masthead .masthead-vertical-bg, .full-width-left #masthead .masthead-vertical-bg, .boxed-right #masthead .masthead-vertical-bg, .full-width-right #masthead .masthead-vertical-bg { '. $mastheadBg .' }';
		// Add styles to CSS variable
	...
	$mastheadBottomGradient = (isset($layoutBottomGradient) && !empty($layoutBottomGradient)) ? $layoutTopGradient : $defaultBottomGradient; 
	...
	if (!empty($color_Heading) && $color_Heading !== '#') {
		...
		// Get the styles
		$headingColorStyles = 'h1, h2, h3, h4, h5, h6, h2.wpb_call_text, .page-title, .headline, .comments-area article header cite, div.wpb_wrapper h4.wpb_toggle, .vc_text_separator div, #page .wpb_accordion .ui-accordion .ui-accordion-header a, #page .wpb_accordion .ui-accordion .ui-accordion-header a:hover, .site-header .site-title a, .entry-title, .entry-title a, .widget .content-rotator-heading, .wpb_carousel .post-title a, .widget-area .widget li[class*="current"] a, .iconBox.icon i.fa, .iconBox .iconBoxTitle { color: '. $color_Heading .'; -webkit-text-stroke: 0.015em '.$colorHeading_rgba.'; }';
		// Add styles to CSS variable
