...
/*function theme_menu_orientation($settings) {
	
	$layoutStyle = get_options_data('options-page', 'layout-style', 'boxed');
	$settings['wpmega-orientation'] = ( $layoutStyle == 'boxed-left' || $layoutStyle == 'full-width-left' ) ? 'vertical' : 'horizontal';

	return $settings;
}
add_filter('wp-mega-menu-settings_settings_filter', 'theme_menu_orientation');*/
